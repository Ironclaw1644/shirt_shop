...
export const categories: Category[] = [
  {
    ...
    subcategories: [
      ...
      { slug: "magnets", name: "Magnets", blurb: "Square and custom-shape." },
      { slug: "magnet-calendars", name: "Magnet Calendars" },
      { slug: "promotional-items", name: "Promotional Items", blurb: "Mouse pads, card holders, desk pieces, CD labels." },
      ...
      { slug: "envelopes", name: "Printed Envelopes" },
