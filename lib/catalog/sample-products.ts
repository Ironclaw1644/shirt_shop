...
export const sampleProducts: SampleProduct[] = [
  // ─── Custom Printing ──────────────────────────────────────────────────────
  {
    ...
    shortDescription: "14pt C2S with matte or gloss finish — the Alpharetta workhorse.",
    description:
      "Full-color both sides on 14pt coated cover. Matte, gloss, or uncoated finish. Ships in 2–3 business days once a proof is approved.",
    basePriceCents: 2900,
  ...
  // ─── Apparel & Headwear ───────────────────────────────────────────────────
  {
    ...
    shortDescription: "Ring-spun 100% cotton tee — the Atlanta team-event favorite.",
    description: "Unisex ring-spun cotton tee in 50+ colors. Blank bulk-priced or decorated with screen print, DTF, or embroidery.",
    basePriceCents: 399,
    priceStatus: "confirmed",
    minQty: 12,
    leadTimeDays: 7,
  ...
  {
    slug: "carhartt-ctk87-tee",
    categorySlug: "apparel-headwear",
    subcategorySlug: "workwear",
    title: "Carhartt Workwear Pocket Tee (CTK87)",
    shortDescription: "6.75oz heavyweight workwear tee — for trades and jobsites.",
    description: "Carhartt's heavyweight pocket tee. Decorates well with screen print and bold embroidery.",
    basePriceCents: 2499,
    priceStatus: "confirmed",
    minQty: 12,
    leadTimeDays: 9,
    ...
    heroPromptKey: "product:carhartt-ctk87",
  },
  {
  ...
  // ─── Photo Gifts ──────────────────────────────────────────────────────────
  {
    ...
    description: "Sublimated 12-can cooler bag with your photo or graphic printed edge-to-edge. Ships in a week.",
    basePriceCents: 2999,
    priceStatus: "confirmed",
    minQty: 1,
    leadTimeDays: 7,
  ...
  },
  {
    ...
    shortDescription: "Single-name tumbler — one-off laser engraving in 3 days.",
    description: "Same Polar Camel body, but for one-of-one gifts. Quick-turn engraving with name, date, or a short line of text. Ships in three business days.",
    basePriceCents: 2499,
    priceStatus: "confirmed",
    minQty: 1,
    leadTimeDays: 3,
