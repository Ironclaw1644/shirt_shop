...
/**
 * Receives the populated-collection count for each top-level category as a
 * prop computed in the server wrapper. Keeps `sampleProducts` (and the 13MB
 * imported-blanks payload) out of the client bundle.
 */
      ...
      <div className="container">
        ...
        <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
          {categories.map((c, idx) => {
            const n = populatedCounts[c.slug] ?? 0;
                ...
                >
                  ...
                  <div className="relative p-6 bg-card">
                    ...
                    <div className="mt-4 flex items-center justify-between text-sm">
                      <span className="text-ink-mute font-mono">{countLabel}</span>
